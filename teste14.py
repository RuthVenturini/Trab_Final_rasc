...
locais = [
    ...
    ("Jardim Botânico", "https://www.curitiba.pr.gov.br/conteudo/jardim-botanico/174"),
    ("Parque Tanguá", "https://www.curitiba.pr.gov.br/conteudo/parque-tangua/176"),
    ("Museu Oscar Niemeyer", "https://www.museuoscarniemeyer.org.br/"),
    ("Parque Barigui", "https://www.curitiba.pr.gov.br/conteudo/parque-barigui/175"),
    ("Santa Felicidade", "https://www.curitiba.pr.gov.br/conteudo/santa-felicidade/187"),
    ("Bosque do Alemão", "https://www.curitiba.pr.gov.br/conteudo/bosque-do-alemao/180"),
    ("Feira do Largo da Ordem", "https://www.curitiba.pr.gov.br/conteudo/feira-do-largo-da-ordem/79"),
    ("Memorial da Segurança no Transporte", "https://www.memorialseguranca.com.br/"),
    ("Shopping Pátio Batel", "https://www.patiobatel.com.br/"),
    ("Ligga Arena", "https://www.liggaarena.com.br/"),
    ("Museu de Arte Indígena", "https://museudearteindigena.com.br/"),
    ("Memorial Ucraniano", "https://www.curitiba.pr.gov.br/conteudo/memorial-ucraniano/181"),
    ("Shopping Estação", "https://www.shoppingestacao.com.br/"),
    ("Museu do Holocausto de Curitiba", "https://www.museudoholocausto.org.br/"),
]

for nome, url, lat, lon, cor in locais:
    html_popup = f'<b>{nome}</b><br><a href="{url}" target="_blank">Visite o site</a>'
    popup = folium.Popup(html_popup, max_width=300, parse_html=True)
    folium.Marker(
        location=[lat, lon],
        popup=popup,
